INSERT INTO items_x_products (item_x_product_id, product_id, item_id, amount)
VALUES (1, 1, 1, 50), (2, 1, 2, 20), (3, 1, 3, 1), (4, 1, 4, 1), (5, 1, 22, 5);
-- El mojito lleva 50 ml de ron, 20 gramos de azúcar, 1 unidad de limón, 1 rama de hierbabuena y 5 cubos de hielo.
INSERT INTO items_x_products (item_x_product_id, product_id, item_id, amount)
VALUES (6, 2, 1, 50), (7, 2, 2, 20), (8, 2, 5, 100), (9, 2, 6, 1), (10, 2, 7, 50), (11, 2, 22, 5);
...
INSERT INTO items_x_products (item_x_product_id, product_id, item_id, amount)
VALUES (12, 3, 1, 50), (13, 3, 2, 20), (14, 3, 9, 25), (15, 3, 3, 1), (16, 3, 10, 1), (17, 3, 22, 5);
...
INSERT INTO items_x_products (item_x_product_id, product_id, item_id, amount)
VALUES (18, 4, 1, 50), (19, 4, 2, 20), (20, 4, 3, 1), (21, 4, 10, 1), (22, 4, 22, 5);
-- El daiquiri lleva 50 ml de ron, 20 gramos de azúcar, 1 unidad de lima, 1 unidad de hielo y 5 cubos de hielo.
INSERT INTO items_x_products (item_x_product_id, product_id, item_id, amount)
VALUES (23, 5, 1, 50), (24, 5, 2, 20), (25, 5, 11, 100), (26, 5, 25, 50), (27, 5, 3, 1), (28, 5, 21, 25), (29, 5, 22, 5);
...
INSERT INTO items_x_products (item_x_product_id, product_id, item_id, amount)
VALUES (45, 9, 8, 50), (46, 9, 25, 100), (47, 9, 29, 200), (48, 9, 24, 15), (49, 9, 3, 1), (50, 9, 22, 3);
...
INSERT INTO items_x_products (item_x_product_id, product_id, item_id, amount)
VALUES (51, 10, 34, 50), (52, 10, 1, 50), (53, 10, 2, 25), (54, 10, 22, 3);
-- El Mango lleva 50 gramos de mango, 50 ml de Ron, 25 gramos de azúcar y 3 cubos de hielo.
INSERT INTO items_x_products (item_x_product_id, product_id, item_id, amount)
VALUES (55, 11, 35, 50), (56, 11, 1, 50), (57, 11, 2, 25), (58, 11, 22, 3);
-- El Fresa lleva 50 gramos de fresas, 50 ml de Ron, 25 gramos de azúcar y 3 cubos de hielo.
INSERT INTO items_x_products (item_x_product_id, product_id, item_id, amount)
VALUES (59, 12, 18, 150), (60, 12, 12, 10), (61, 12, 13, 50), (62, 12, 14, 1000), (63, 12, 16, 150), (64, 12, 15, 10), (65, 12, 22, 3);

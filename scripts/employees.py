...
for i in range(15):
    ...
    data.append((i+1, birth_date, first_name, last_name, phone, email, iban_account))

# prepare the insert statement
stmt = "INSERT INTO employees (employee_id, birth_date, first_name, last_name, phone, email, iban_account) VALUES (%s, %s, %s, %s, %s, %s, %s)"
cursor = db.cursor()
